...
import com.krak.krakowautobusy.ui.search.AdapterListSearchVehicleStop
import com.krak.krakowautobusy.ui.search.SearchViewVehicleStop
...
class FavouriteVehicleStop : Fragment() {
    ...
    fun addAdapterToListFavouriteVehicleStop(){
        ...
        var adapter=
            AdapterListSearchVehicleStop(Api.getApi().getAllFavouriteVehicleStop(),requireContext())

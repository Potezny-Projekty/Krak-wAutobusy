...
import com.krak.krakowautobusy.ui.markers.BusStopMarker
import com.krak.krakowautobusy.ui.markers.BusStopMarkerCluster
...
open class BusStopPosition(private val busStopIconDrawable : Drawable) {
    ...
    protected fun createBusStopMarker(map : MapView,
        ...
        marker.position = ConvertUnits.convertToGeoPoint(
            vehicleStopData.latitude,

...
import com.krak.krakowautobusy.ui.location.GeoPointInterpolator
import com.krak.krakowautobusy.ui.map.vehicledata.*
import com.krak.krakowautobusy.ui.markers.*
...
open class ActualPositionVehicles(var drawables: Drawables) {
    ...
    fun drawAllVehiclesStopForLinesOnMap(vehicleStops: ArrayList<SequenceVehicleStopData>, map: MapView) {
        ...
        for (vehStop in vehicleStops) {
            ...
            val vehicleStopMarker= BusStopMarker(map, VehicleStopData(defaultValue,vehStop.nameVehicleStop,vehStop.longitude,vehStop.latitude,
                defaultValue.toInt(),
                VehicleType.BUS,vehStop.idStopPoint,false))
    ...
    protected fun drawMarkerVehiclesOnMap(vehicle: Vehicle, map: MapView): VehicleMarker {
        ...
        if (vehicle.category == com.krak.krakowautobusy.ui.map.vehicledata.VehicleType.BUS.type) {
            fillMarkerData(
                marker, busDrawable, com.krak.krakowautobusy.ui.map.vehicledata.VehicleType.BUS.type, vehicle.name
            )
        } else {
            fillMarkerData(
                marker, tramDrawable,
                com.krak.krakowautobusy.ui.map.vehicledata.VehicleType.TRAM.type, vehicle.name
            )
        }
    ...
    private fun drawPathVehicle(
        ...
        if (type == com.krak.krakowautobusy.ui.map.vehicledata.VehicleType.TRAM.type) {
